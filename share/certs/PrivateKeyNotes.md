...
unlocked to sign the MB8Coin-Qt.app bundle.
...
allowing somebody to distribute a MB8Coin-Qt.app or mb8coin-qt-setup.exe with a valid
...
that the mb8coin-qt.exe file inside the installer had not been tampered with.
