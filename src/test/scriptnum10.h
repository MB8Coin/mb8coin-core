...
#ifndef MB8COIN_TEST_SCRIPTNUM10_H
#define MB8COIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from MB8Coin Core 0.10.0, for cross-comparison.
 */
public:
