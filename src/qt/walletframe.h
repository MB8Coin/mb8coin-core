...
#ifndef MB8COIN_QT_WALLETFRAME_H
#define MB8COIN_QT_WALLETFRAME_H
...
public:
    explicit WalletFrame(const PlatformStyle *platformStyle, MB8CoinGUI *_gui = 0);
    ~WalletFrame();
...
#endif // MB8COIN_QT_WALLETFRAME_H
