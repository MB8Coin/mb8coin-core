...
#ifndef MB8COIN_QT_MB8COINUNITS_H
#define MB8COIN_QT_MB8COINUNITS_H
...
/** MB8Coin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MB8CoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MB8CoinUnits(QObject *parent);

    /** MB8Coin units.
      @note Source: https://en.mb8coin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MB8,
...
typedef MB8CoinUnits::Unit MB8CoinUnit;

#endif // MB8COIN_QT_MB8COINUNITS_H
