...
public:
    TxViewDelegate(const PlatformStyle *platformStyle):
        QAbstractItemDelegate(), unit(MB8CoinUnits::MB8),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        QString amountText = MB8CoinUnits::formatWithUnit(unit, amount, true, MB8CoinUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& stakingBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(MB8CoinUnits::formatWithUnit(unit, balance, false, MB8CoinUnits::separatorAlways));
    ui->labelUnconfirmed->setText(MB8CoinUnits::formatWithUnit(unit, unconfirmedBalance, false, MB8CoinUnits::separatorAlways));
    ui->labelStaking->setText(MB8CoinUnits::formatWithUnit(unit, stakingBalance, false, MB8CoinUnits::separatorAlways));
    ui->labelImmature->setText(MB8CoinUnits::formatWithUnit(unit, immatureBalance, false, MB8CoinUnits::separatorAlways));
    ui->labelTotal->setText(MB8CoinUnits::formatWithUnit(unit, balance + unconfirmedBalance + stakingBalance, false, MB8CoinUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("MB8")
    updateDisplayUnit();
}
...
void OverviewPage::updateStakeReport(bool fImmediate=false)
{
    ...
    ui->label24hStakingStats->setText(MB8CoinUnits::formatWithUnit(unit, aRange[i++].Total, false, MB8CoinUnits::separatorAlways));
    ui->label7dStakingStats->setText(MB8CoinUnits::formatWithUnit(unit, aRange[i++].Total, false, MB8CoinUnits::separatorAlways));
    ui->label30dStakingStats->setText(MB8CoinUnits::formatWithUnit(unit, aRange[i++].Total, false, MB8CoinUnits::separatorAlways));
