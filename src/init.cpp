...
// Copyright (c) 2017 The MB8Coin developers
 ...
 * between mb8coind, and mb8coin-qt and non-server tools.
*/
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-conf=<file>", strprintf(_("Specify configuration file (default: %s)"), MB8COIN_CONF_FILENAME));
    if (mode == HMM_MB8COIND)
    {
#ifndef WIN32
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), MB8COIN_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/mb8coindev/mb8coin-core>";
    const std::string URL_WEBSITE = "<https://mb8coin.org>";
...
/** Sanity checks
 *  Ensure that MB8Coin is running in a usable environment with all
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single MB8Coin process is using the data directory.
    ...
    threadGroup.create_thread(boost::bind(&MB8CoinStaker, boost::cref(chainparams)));
#endif
