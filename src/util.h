 ...
 */
#ifndef MB8COIN_UTIL_H
#define MB8COIN_UTIL_H
...
extern const char * const MB8COIN_CONF_FILENAME;
extern const char * const MB8COIN_PID_FILENAME;
...
{
    std::string s = strprintf("mb8coin-%s", name);
