...
This document provides guidelines for internationalization of the MB8Coin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `mb8coin_en.ts` remains unchanged.
