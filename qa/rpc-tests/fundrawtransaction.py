...
class RawTransactionsTest(MB8CoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid mb8coin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid mb8coin address" in e.error['message'])
